...
public class CalculatorProxy implements com.basheer.service.Calculator {
  private String _endpoint = null;
  private com.basheer.service.Calculator calculator = null;
  ...
  private void _initCalculatorProxy() {
    try {
      calculator = (new com.basheer.service.CalculatorServiceLocator()).getCalculator();
      if (calculator != null) {
        if (_endpoint != null)
  ...
  public com.basheer.service.Calculator getCalculator() {
    if (calculator == null)
      _initCalculatorProxy();
    return calculator;
  }
