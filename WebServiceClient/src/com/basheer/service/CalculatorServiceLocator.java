...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.basheer.service.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/JaxwsProject/services/Calculator";
    ...
    public com.basheer.service.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.basheer.service.CalculatorSoapBindingStub _stub = new com.basheer.service.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.basheer.service.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.basheer.service.CalculatorSoapBindingStub _stub = new com.basheer.service.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.basheer.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.basheer.com", "Calculator"));
        }
